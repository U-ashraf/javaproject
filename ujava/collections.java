...
/* Next, Map.Entry is used to retrieve the key-value pair from the iterator using i.next(). The key is accessed 
 using mp.getKey() and the value is accessed using mp.getValue(). These key-value pairs are then printed using 
 System.out.println().*/
	}
}
